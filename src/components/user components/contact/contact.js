...
const Contact = () => {
  ...
  return (
    <div className="contact">
      ...
      <p>
        Lorem ipsum dolor sit amet, deleniti <br></br> repellat voluptatem error
        exercitationem.
      </p>
      <div className="form">
        <input type="text" placeholder="Name" className="name" /> <br /> <hr />
      ...
      <div className="box-2">
        ...
        <table>
            <tr>
                <td><img src={surat} alt="" /></td>
                <td>lenacahyani82@gmail.com</td>
            </tr>
            <tr>
                <td className="pt-5 pe-4"><img src={telpon} alt=""  /></td>
                <td  className="pt-5">lenacahyani82@gmail.com</td>
            </tr>
            <tr>
                <td  className="pt-5"><img src={gedung} alt="" /></td>
                <td  className="pt-5">lenacahyani82@gmail.com</td>
            </tr>
            <tr>
                <td  className="pt-5"><img src={jam} alt="" /></td>
                <td  className="pt-5">lenacahyani82@gmail.com</td>
            </tr>
